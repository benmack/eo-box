...
def extracted_data_1(extraction_input_1, tmpdir):
    ...
    exit_code = extract(src_vector=extraction_input_1["src_vector"],
    ...
    extraction_input_1["extracted_files"] = [(extraction_input_1["extracted_dir"] / bname) for bname in expected_basenames]
...
def test_extract_and_save_to_npy_rerun_on_existing_data_successfully(extracted_data_1):
    ...
    exit_code = extract(src_vector=extracted_data_1["src_vector"],
