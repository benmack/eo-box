...
project = 'eo-box'
copyright = '2018, eo-box'
author = 'Benjamin Mack'
doc_title = 'eo-box Documentation'
...
# for line in open(os.path.join(os.path.dirname(__file__), '../../raster/eobox/raster/__init__.py')):
...
latex_documents = [
    (master_doc, 'eo-box.tex', doc_title,
     author, 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'eo-box', doc_title,
     author, 'eo-box', 'One line description of project.',
     'Miscellaneous'),
]
